# from https://github.com/GeeeekExplorer/nano-vllm/pull/29
import os
import time
import numpy as np
import argparse
...
def main():
    ...
    parser.add_argument("--model-path", type=str, default="pretrained/Qwen3-0.6B", help="Path to the model.")
...
if __name__ == "__main__":
    # python -m tests.serving_bench --request-rate 128 --num-requests 1024 --model-path pretrained/Qwen3-0.6B
    # python -m tests.serving_bench --request-rate 128 --num-requests 1024 --model-path pretrained/gemma-3-4b-it-text-only
    main()